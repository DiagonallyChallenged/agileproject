...
RSpec.describe Piece, type: :model do
  ...
  describe 'obstructed? method' do
    it 'should return false if path is clear' do
      ...
      piece2 = FactoryBot.create(:piece, id: 2, x_location: 3, y_location: 3, game_id: game.id, user_id: user.id)
    ...
    it 'should return true for horizontal obstructions' do
      ...
      user = FactoryBot.create(:user)
      piece1 = FactoryBot.create(:piece, id: 1, x_location: 1, y_location: 1, game_id: game.id, user_id: user.id)
      piece2 = FactoryBot.create(:piece, id: 2, x_location: 3, y_location: 1, game_id: game.id, user_id: user.id)
    ...
    it 'should return true for vertical obstructions' do
      ...
      piece2 = FactoryBot.create(:piece, id: 2, x_location: 1, y_location: 3, game_id: game.id, user_id: user.id)
